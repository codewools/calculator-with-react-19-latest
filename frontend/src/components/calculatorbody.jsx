        ...
        <div className='flex justify-between bg-gray-200'>
          ...
          <div className='w-70 bg-gray-200 h-115 p-2 '>
            {arrOfNumbers.map((item) => (
              <p key={item} onClick={handler} className={` ${item === "AC" ? "bg-red-500 " : " bg-white"} float-left text-xl mr-2 mt-2 cursor-pointer rounded-full shadow-xl items-center justify-center w-20 h-20 flex  `}>
                {item}
              </p>
            ))}
          </div>
